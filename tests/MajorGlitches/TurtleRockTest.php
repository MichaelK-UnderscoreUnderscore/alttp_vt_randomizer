...
class TurtleRockTest extends TestCase
{
    ...
    public function accessPool()
    {
        return [
            ...
            ["Turtle Rock - Crystaroller Room", true, ['Lamp', 'CaneOfSomaria', 'MoonPearl']],
            ["Turtle Rock - Crystaroller Room", true, ['Lamp', 'CaneOfSomaria', 'Bottle']],
            
            ["Turtle Rock - Eye Bridge - Bottom Left", false, []],
            ["Turtle Rock - Eye Bridge - Bottom Left", false, [], ['MoonPearl', 'CaneOfSomaria', 'AnyBottle']],
            ["Turtle Rock - Eye Bridge - Bottom Left", false, [], ['MoonPearl', 'Lamp', 'AnyBottle']],
            ["Turtle Rock - Eye Bridge - Bottom Left", true, ['Lamp', 'CaneOfSomaria', 'KeyD7', 'KeyD7', 'KeyD7', 'BigKeyD7']],
            ["Turtle Rock - Eye Bridge - Bottom Left", true, ['MoonPearl']],
            ["Turtle Rock - Eye Bridge - Bottom Left", true, ['Bottle']],

            ["Turtle Rock - Eye Bridge - Bottom Right", false, []],
            ["Turtle Rock - Eye Bridge - Bottom Right", false, [], ['MoonPearl', 'CaneOfSomaria', 'AnyBottle']],
            ["Turtle Rock - Eye Bridge - Bottom Right", false, [], ['MoonPearl', 'Lamp', 'AnyBottle']],
            ["Turtle Rock - Eye Bridge - Bottom Right", true, ['Lamp', 'CaneOfSomaria', 'KeyD7', 'KeyD7', 'KeyD7', 'BigKeyD7']],
            ["Turtle Rock - Eye Bridge - Bottom Right", true, ['MoonPearl']],
            ["Turtle Rock - Eye Bridge - Bottom Right", true, ['Bottle']],

            ["Turtle Rock - Eye Bridge - Top Left", false, []],
            ["Turtle Rock - Eye Bridge - Top Left", false, [], ['MoonPearl', 'CaneOfSomaria', 'AnyBottle']],
            ["Turtle Rock - Eye Bridge - Top Left", false, [], ['MoonPearl', 'Lamp', 'AnyBottle']],
            ["Turtle Rock - Eye Bridge - Top Left", true, ['Lamp', 'CaneOfSomaria', 'KeyD7', 'KeyD7', 'KeyD7', 'BigKeyD7']],
            ["Turtle Rock - Eye Bridge - Top Left", true, ['MoonPearl']],
            ["Turtle Rock - Eye Bridge - Top Left", true, ['Bottle']],

            ["Turtle Rock - Eye Bridge - Top Right", false, []],
            ["Turtle Rock - Eye Bridge - Top Right", false, [], ['MoonPearl', 'CaneOfSomaria', 'AnyBottle']],
            ["Turtle Rock - Eye Bridge - Top Right", false, [], ['MoonPearl', 'Lamp', 'AnyBottle']],
